// ============================================================
// PROFIT 24 - COMPLETE BACKEND SERVER v12
// Investment Platform with Telegram Bot Admin Panel
// ============================================================
// Features:
// - User Authentication (JWT)
// - PID System (Auto-generated from WhatsApp)
// - 11 Investment Plans (configurable via Telegram)
// - Multiple Plans per User
// - Multiple Withdrawals per User
// - Deposit with Screenshot Upload
// - Withdrawal with Balance Deduction
// - Fund Transfer via PID
// - Referral System (11% Bonus)
// - Daily Profit Distribution (Cron Job)
// - Telegram Bot Admin Panel (Full Control)
// - Auto Notifications to Admin
...
const depositStorage = multer.diskStorage({
    ...
    filename: function (req, file, cb) {
        ...
        const finalName = 'deposit-' + uniquePrefix + '-' + safeFilename;
        cb(null, finalName);
    }
});
...
const profileStorage = multer.diskStorage({
    ...
    filename: function (req, file, cb) {
        const uniquePrefix = Date.now() + '-' + Math.round(Math.random() * 1E9);
        const safeFilename = file.originalname.replace(/[^a-zA-Z0-9.]/g, '_');
        const finalName = 'profile-' + uniquePrefix + '-' + safeFilename;
        cb(null, finalName);
    }
});
...
const userSchema = new mongoose.Schema({
    ...
    pid: {
        ...
        unique: true,
        required: true,
        comment: 'Profit ID - Last 5 digits of WhatsApp number'
    },
    profilePic: {
        type: String,
        default: null
    ...
    referralCode: {
        type: String,
        unique: true,
        comment: 'Same as PID, used for referral links'
    },
    referredBy: {
        type: String,
        default: null,
        comment: 'PID of the user who referred this user'
    },
    activePlans: [{
        planId: {
            type: Number
